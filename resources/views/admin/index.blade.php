                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item hidden-on-mobile">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                                <li><a class="dropdown-item" href="#"><img src="../images/flags/germany.png" alt="">German</a></li>
                                <li><a class="dropdown-item" href="#"><img src="../images/flags/italy.png" alt="">Italian</a></li>
                                <li><a class="dropdown-item" href="#"><img src="../images/flags/china.png" alt="">Chinese</a></li>
                            </ul>
                        </li>
                        <li class="nav-item hidden-on-mobile">
        ...
        <div class="content-wrapper">
            <div class="container">
                                ...
                                <div class="widget-payment-request-container">
                                    ...
                                    <div class="widget-payment-request-product">
                                        <div class="widget-payment-request-product-image m-r-sm">
                                            <img src="../images/other/facebook_logo.png" class="mt-auto" alt="">
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="widget-popular-product-container">
                                    <div class="widget-popular-product-image">
                                        <img src="../images/widgets/popular-product.jpeg" alt="">
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card">
                            <img src="../images/widgets/blog5.jpeg" class="card-img-top" alt="...">
                            <div class="card-body">
                        ...
                        <div class="card widget widget-info">
                            <div class="card-body">
                                <div class="widget-info-container">
                                    <div class="widget-info-image" style="background: url('../images/widgets/security.svg')"></div>
                            ...
                            <div class="card-body">
                                <div class="widget-popular-blog-container">
                                    <div class="widget-popular-blog-image">
                                        <img src="../images/widgets/product2.jpeg" alt="">
                                    </div>
